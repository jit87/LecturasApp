...
export async function agregarLibro(req, res) {
    ...
    const { titulo, autores, editor, fechaPublicacion, descripcion, pageCount, averageRating, ratingsCount, contentVersion, imagen, lengua, previewLink, estado, coleccion, categorias, APIid, resena } = req.body;
